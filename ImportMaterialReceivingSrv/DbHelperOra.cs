...
namespace ImportMaterialReceivingSrv
{
    ...
    {
        private static readonly ILog logger = LogManager.GetLogger(typeof(DbHelperOra));
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.        
        public static string connectionString = ConfigurationManager.ConnectionStrings["sqlDB"].ToString();
        public DbHelperOra()
        {
        }
